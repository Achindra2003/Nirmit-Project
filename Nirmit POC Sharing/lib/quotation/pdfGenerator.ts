...
import { formatINR } from './billOfQuantities';
...
export function generateQuotationPDF(
  ...
  addLine('TOTAL ESTIMATE', 10, false, '#555');
  addLine(`${formatINR(boq.total)}`, 22, true);
  addSpacer(4);
  addLine('(Includes 10% contingency)', 9, false, '#888');
  addSpacer(10);
  ...
  addSpacer(2);
  addLine(`TOTAL: ${formatINR(boq.total)}`, 14, true, '#1C1917');
  addSpacer(6);
